...
(async () => {
  ...
  await fs.writeFile("diuretics-thiazide-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("diuretics-thiazide-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
